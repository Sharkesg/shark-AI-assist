...
def ai(txt):
    ...
    response = model.generate_content("from now your name is shark and your a ARTIFICIAL INTELLIGENCE which i help you and clarify your doubts, your real name is sharkesh and reply to this in short: "+txt)
